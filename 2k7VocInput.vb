...
#Region " Windows Form Designer generated code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.lblWords.Size = New System.Drawing.Size(35, 13)
    ...
    Me.lblUnits.Size = New System.Drawing.Size(35, 13)
...
#End Region
  ...
  Private Sub cmbGroups_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbGroups.SelectedIndexChanged
    ...
    ldf = New xlsLDF(ldfManagement.LDFFullPath)
  ...
  Private Sub lstWordTypes_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles lstWordTypes.SelectedIndexChanged
    ...
    ' Falls irreguläre angezeigt werden, sicherheitsalber alle vorher einblenden!
  ...
  Private Sub Save()
    ...
    If bWordChanged Then
      Dim iLastIndex As Integer = lstWords.SelectedIndex
  ...
  Private Sub txtPre_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtPre.GotFocus
    txtPre.SelectAll()
  End Sub
  ...
  Private Sub txtWord_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtWord.GotFocus
    txtWord.SelectAll()
  End Sub

  Private Sub txtWord_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtWord.LostFocus
    If bWordChanged = False Then bWordChanged = (voc.CurrentWord.Word <> Me.txtWord.Text) And (Me.lstWords.Items.Count > 0)
  ...
  Private Sub txtAdditionalInfo_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtAdditionalInfo.GotFocus
    txtAdditionalInfo.SelectAll()
  End Sub

  Private Sub txtAdditionalInfo_LostFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtAdditionalInfo.LostFocus
  ...
  Private Sub txtMeaning_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtMeaning.GotFocus
    txtMeaning.SelectAll()
  End Sub

  Private Sub txtGrammar1_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGrammar1.GotFocus
    txtGrammar1.SelectAll()
  End Sub

  Private Sub txtGrammar2_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGrammar2.GotFocus
    txtGrammar2.SelectAll()
  End Sub

  Private Sub txtGrammar3_GotFocus(ByVal sender As Object, ByVal e As System.EventArgs) Handles txtGrammar3.GotFocus
    txtGrammar3.SelectAll()
  End Sub

  Private Sub ShowGrammar()
    ' eintragen der jeweiligen form in das feld, falls irregular aus ist. ansonsten nix tun
    ...
    If chkIrregular.Checked Then ' irregular ist an, ausblenden falls in der neuen form weniger möglichkeiten
      If txtGrammar1.Enabled = False Then txtGrammar1.Text = "" ' Else txtGrammar1.Text = voc.CurrentWord.Extended1
      If txtGrammar2.Enabled = False Then txtGrammar2.Text = "" ' Else txtGrammar2.Text = voc.CurrentWord.Extended2
      If txtGrammar3.Enabled = False Then txtGrammar3.Text = "" ' Else txtGrammar3.Text = voc.CurrentWord.Extended3
    Else
      ' versuchen, die entsprechenden formen zu bilden
      ' immer die gebildete form anzeigen, nie aus datei lesen!
      ldf.UseRule(voc.CurrentWord, 1)
      txtGrammar1.Text = ldf.Output
      ldf.UseRule(voc.CurrentWord, 2)
      txtGrammar2.Text = ldf.Output
      ldf.UseRule(voc.CurrentWord, 3)
      txtGrammar3.Text = ldf.Output
      If lblGrammar1.Text = "" Then txtGrammar1.Text = ""
      If lblGrammar2.Text = "" Then txtGrammar2.Text = ""
      If lblGrammar3.Text = "" Then txtGrammar3.Text = ""
    End If
  End Sub
End Class
