...
#Region " Vom Windows Form Designer generierter Code "
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.MenuItem6.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuShowVocabularyExplorer, Me.mnuDictionaryInsert, Me.mnuAddGroups, Me.MenuItem11, Me.MenuItem13, Me.mnuVocStatistic})
    ...
    Me.mnuAddGroups.Text = "&Gruppen eingeben"
    '
    'MenuItem11
    '
    ...
    Me.MenuItem13.MenuItems.AddRange(New System.Windows.Forms.MenuItem() {Me.mnuTest, Me.mnuTestGroups, Me.mnuTestVocabulary})
    Me.MenuItem13.Text = "&Abfragen"
    '
    'mnuTest
    '
    Me.mnuTest.Index = 0
    Me.mnuTest.Text = "A&llgemein"
    '
    'mnuTestGroups
    '
...
#End Region
  ...
  Private Sub mnuAddGroups_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuAddGroups.Click
    ...
    frmGroupInput.WindowState = FormWindowState.Maximized
    frmGroupInput.Show()
  End Sub
  ...
  Private Sub mnuTest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuTest.Click
    ...
    Dim frmTest As New TestSimple(True, "italian")
  ...
  Private Sub mnuTestGroups_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuTestGroups.Click
    ...
    Dim group As xlsGroup = frmSelect.SelectedGroup
    If group Is Nothing Then Exit Sub
    If group.WordCount = 0 Then Exit Sub
    frmSelect.Close()
    Dim frmTest As New TestSimple(group.GroupTable)
    Try
      frmTest.ShowDialog(Me)
    Catch ex As ObjectDisposedException
      ' Die form kann nicht angezeigt werden
      MsgBox("Keine Vokabeln zum Abgragen", MsgBoxStyle.Information, "Vokabelinformation")
    End Try
  End Sub

  Private Sub mnuTestVocabulary_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles mnuTestVocabulary.Click
    ' Abfragen von Vokabeln aus dem Programm, ohne einschränkung
    Dim frmTest As New TestSimple(False, "")
    frmTest.ShowDialog(Me)
  End Sub
End Class