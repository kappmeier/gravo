...
Public Class GroupDtoTests
    ...
    Private ReadOnly testWord1 As TestWord = New TestWord(New MockWordEntry(1, "word1", "pre", "post", WordType.Verb, "m", "l", False), True, "")
    Private ReadOnly testWord2 As TestWord = New TestWord(New MockWordEntry(2, "word2", "", "", WordType.Verb, "", "", False), True, "An example.")
    Private ReadOnly testWord29 As TestWord = New TestWord(New MockWordEntry(29, "wordx", "", "", WordType.Adjective, "", "", True), False, "")

    Private ReadOnly word3 As WordEntry = New WordEntry("some word", "", "", WordType.Verb, "with a meaning", "", True)
    Private ReadOnly word4 As WordEntry = New WordEntry("word4", "", "", WordType.Adjective, "test", "info", False)

    ReadOnly exampleGroup As GroupEntry = New GroupEntry(123, "Test-Example", "Subgroup1", "GroupTest-Example01")
    ReadOnly emptyGroup As GroupEntry = New GroupEntry(123, "Test-Example", "Empty subgroup", "GroupTest-Example02")

    Private ReadOnly defaultWords As List(Of TestWord) = New List(Of TestWord) From {testWord1, testWord2, testWord29}
