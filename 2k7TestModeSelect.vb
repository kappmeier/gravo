...
#Region " Windows Form Designer generated code "
  ...
  Friend WithEvents cmbTestSystem As System.Windows.Forms.ComboBox
  ...
  <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
    ...
    Me.cmbTestSystem = New System.Windows.Forms.ComboBox
    ...
    Me.cmdOK.Location = New System.Drawing.Point(277, 196)
    Me.cmdOK.Name = "cmdOK"
    ...
    Me.cmbNextWordModesWrong.Size = New System.Drawing.Size(168, 21)
    ...
    Me.chkFirstTry.Location = New System.Drawing.Point(184, 104)
    Me.chkFirstTry.Name = "chkFirstTry"
    Me.chkFirstTry.Size = New System.Drawing.Size(178, 18)
    ...
    Me.chkOnlyUsed.Location = New System.Drawing.Point(184, 128)
    Me.chkOnlyUsed.Name = "chkOnlyUsed"
    Me.chkOnlyUsed.Size = New System.Drawing.Size(178, 16)
    ...
    Me.chkDescription.Location = New System.Drawing.Point(184, 151)
    Me.chkDescription.Name = "chkDescription"
    Me.chkDescription.Size = New System.Drawing.Size(178, 16)
    Me.chkDescription.TabIndex = 14
    Me.chkDescription.Text = "Beschreibung immer anzeigen"
    '
    'cmbTestSystem
    '
    Me.cmbTestSystem.Location = New System.Drawing.Point(184, 72)
    Me.cmbTestSystem.Name = "cmbTestSystem"
    Me.cmbTestSystem.Size = New System.Drawing.Size(168, 21)
    Me.cmbTestSystem.TabIndex = 15
    Me.cmbTestSystem.Text = "cmbTestSystem"
    '
    'Label4
    '
    ...
    Me.Label4.Text = "Abfragesystem:"
    '
    'TestModeSelect
    '
    Me.AcceptButton = Me.cmdOK
    Me.AutoScaleBaseSize = New System.Drawing.Size(5, 13)
    Me.ClientSize = New System.Drawing.Size(359, 231)
    Me.Controls.Add(Me.Label4)
    Me.Controls.Add(Me.cmbTestSystem)
...
#End Region
  ...
  Private Sub TestModeSelect_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Next i
    Me.cmbTestSystem.Items.Add("Alle")
    Me.cmbTestSystem.Items.Add("Karteikartensystem")
    Me.cmbNextWordModes.SelectedIndex = 1
    Me.cmbNextWordModesWrong.SelectedIndex = 4
    Me.cmbxlsVocTestExtendedModes.SelectedIndex = 0
    Me.cmbTestSystem.SelectedIndex = 0
  End Sub

  Public Overloads WriteOnly Property Parent() As VocTest
    Set(ByVal parentWindow As VocTest)
      m_Parent = parentWindow
    End Set
  End Property

  Private Sub cmdOK_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmdOK.Click
    Select Case cmbTestSystem.SelectedIndex
      Case 0
        m_Parent.TestSystem = xlsTestSystem.All
      Case 1
        m_Parent.TestSystem = xlsTestSystem.Cards
    End Select
    Me.Close()
  End Sub
  ...
  Private Sub cmbTestSystem_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles cmbTestSystem.SelectedIndexChanged
